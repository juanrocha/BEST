...
mod_pool <- spml(
  ind_extraction ~ StockSizeBegining + Treatment + 
  part + part*Treatment, data = pdat, index = NULL, 
  listw = spdep::mat2listw(A), model = "pooling", lag = TRUE, spatial.error = "b")
...
#summary(mod1)
stargazer::stargazer(coeftest(mod_re), coeftest(mod_pool), type = "html", multicolumn = FALSE, header = FALSE, intercept.bottom = FALSE, digits = 2)
```
