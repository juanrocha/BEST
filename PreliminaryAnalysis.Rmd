...
#grid.arrange(
  pm1   + theme(text= element_text(family='Helvetica', size=8))
  pm2   + theme(text= element_text(family='Helvetica', size=8))
  pm3   + theme(text= element_text(family='Helvetica', size=8))
  pm4   + theme(text= element_text(family='Helvetica', size=8))
#  ncol=2, nrow=2
#)
